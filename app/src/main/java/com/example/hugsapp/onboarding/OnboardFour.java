...
public class OnboardFour extends Fragment {
    Activity mActivity;
    Context mContext;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        configuration = new RemoteConfiguration(mContext);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.onboard_four_fragment, null);
        ...
        String instructions = configuration.getInstructions().replace("|", "\n");
